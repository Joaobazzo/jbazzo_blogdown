...
Prior to moving to the IPEA, I completed a Master's degree in Environmental Engineering at the Federal University of Paraná (UFPR), supervised by Prof. [Marcelo Errera](http://www.ambiental.ufpr.br/portal/professores/merrera/). In the study, I proposed an integration between transport and emissions model, in order to evaluate the impact of different urban mobility policies on overall emissions levels. During my free time, I also contribute to Brazilian non-governmental organizations (NGOs) that promote the use of bicycle as mode of transport, especially [Cicloiguaçu](https://cicloiguacu.org.br/) and [Brasília para Pessoas](https://brasiliaparapessoas.wordpress.com/). 
